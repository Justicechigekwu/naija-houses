...
//       ) {
//         const clickedBackdrop = target instanceof Element
...
//   const handleSelect = (listing: { _id: string; slug?: string }) => {
//     setShowSuggestions(false);
//     setFilters((prev: any) => ({ ...prev, search: "" }));
  
//     const href = listing.slug ? `/listings/${listing.slug}` : `/listings/${listing._id}`;
//     router.push(href);
