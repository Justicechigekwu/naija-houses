...
//         <div
//           className={`flex items-center justify-center rounded-[28px] bg-red-500 shadow-lg transition-all duration-700 ${
//             visible ? "scale-100 opacity-100" : "scale-95 opacity-0"
//           } h-36 w-36 sm:h-40 sm:w-40`}
//         >
//           <div className="relative h-20 w-20 sm:h-24 sm:w-24 animate-[veloraPulse_1.8s_ease-in-out_infinite]">
//             <Image
//               src="/velora.png"
//               alt="Velora logo"
//               fill
