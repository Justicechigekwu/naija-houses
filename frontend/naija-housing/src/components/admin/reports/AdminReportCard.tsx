...
// }) {
//   const listingAlreadyDeleted =
//     !report.targetListing?._id ||
//     report.targetListing?.publishStatus === "DELETED";
...
//             disabled={listingAlreadyDeleted || deletingListing}
//             className={`px-3 py-2 rounded text-white ${
//               listingAlreadyDeleted || deletingListing
